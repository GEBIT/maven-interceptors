 ...
 *
 * This is a copy of Maven 3.1 (first slf4j implementation after
 * move to new package). It is needed for serialization.
 * 
    ...
    extends AbstractExecutionListener
{
    ...
    {
        // REMOVED: logger = LoggerFactory.getLogger( ExecutionEventLogger.class );
        logger = null;
    }
